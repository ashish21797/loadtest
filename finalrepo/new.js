...
const getData = async () => { //460+261
    try {

        for (let index = 1000008721; index < 1000009000; index++) {
           ...
           // let final_Gender = Gender.rows[0].gender
            ...
            async function status() {
                ...
                //if (defaultConstructorArray.length == 1000) {
                    ...
                    fs.writeFileSync(__dirname + '/db/new.json', JSON.stringify(defaultConstructorArray));
