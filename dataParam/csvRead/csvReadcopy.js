...
let data1 = [];
     data1 = papaparse.parse(open('./data.csv'), {header: true}).data; // returning array
...
export default function main(){
    // Looping through the credentialsz
    ...
    let response = http.get("https://cachy.com/login", params);
